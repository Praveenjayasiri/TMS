<?php
include_once 'pages/Session_employee/session_employee.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="sidebar">
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
            ...
            echo '<a href="pages/Employees/employee_details.php" class="d-block">Employee ID: ' . $empId . '</a>';
            ?>
        </div>
      </div>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="pages/Task/task_attendence.php" class="nav-link">
                  ...
                  <div class="card-body">
                    <ul class="todo-list" data-widget="todo-list">
                      <li>
                        ...
                        <!-- todo text -->
                        <span class="text">Check All Details</span>
                        <!-- Emphasis label -->
                      ...
                      <li>
                        ...
                        <span class="text">Analysis Pending Tasks</span>
                      ...
                      <li>
                        ...
                        <span class="text">Complete One or More Pending Tasks</span>
                      ...
                      <li>
                        ...
                        <span class="text">Get Task Report Backup</span>
                      ...
                      <li>
                        ...
                        <span class="text">Increace Completed Task Rate</span>
                      ...
                      <li>
                        ...
                        <span class="text">Get Summary Report Backup</span>
...
$(document).ready(function () {
    $.ajax({
      url: 'pages/EmployeeWidget/widget.php',
      type: 'GET',
      dataType: 'json',
